...
<body>
	...
	<div class="admin-content-body">
									...
									<td>
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												...
												<button type="button"  class="btnedit am-btn am-btn-default am-btn-xs am-text-secondary" onclick="javascript:return auditS(${s.stu_id})"> <span class="am-icon-pencil-square-o"></span> 审核</button>
		...
		<script>
			...
			function auditS(id){
				/* alert(id); */
				window.location.href="${pageContext.request.contextPath}/insert/jupload.do?stu_id="+id;
			}
		</script>
</body>
</html>